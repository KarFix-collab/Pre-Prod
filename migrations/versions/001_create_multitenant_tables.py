...
def upgrade() -> None:
    ...
    # Fresh-database bootstrap: create the legacy base tables that this
    # migration expects before applying the tenant-aware schema changes.
    if not inspector.has_table('user'):
        ...
        _create_table_if_missing(
            ...
            sa.Column('part_name', sa.String(100), nullable=False, server_default=''),
        )
