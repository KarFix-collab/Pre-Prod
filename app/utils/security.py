...
import logging
from app.utils.roles import normalize_role, current_role_name
...
def require_auth(user_types: List[str] = None):
    ...
    def decorator(f):
        ...
        def decorated_function(*args, **kwargs):
            ...
            if user_types:
                user_type = normalize_role(current_role_name())
                allowed = {normalize_role(role) for role in user_types}
