...
Supports DATABASE_URL for cloud databases (Supabase, Render)
Includes Supabase Auth configuration for JWT authentication
"""
import os
...
class BaseConfig:
    ...
    # SUPABASE_ANON_KEY:   Public anon key (safe to expose in browser)
    # SUPABASE_JWKS_URL: Optional override for Supabase JWKS verification endpoint
...
class ProductionConfig(BaseConfig):
    ...
    def init_app(app):
        ...
        # Use stdout logging for cloud platforms (Render sets LOG_TO_STDOUT=true)
